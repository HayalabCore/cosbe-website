export default function ArticleCardGridSkeleton({ columns = '3' }: { columns?: '2' | '3' }) {
  ...
  return (
    <div className={`grid ${gridClass} gap-6 animate-pulse`}>
      {Array.from({ length: count }).map((_, i) => (
        <div key={i} className="rounded-lg border border-gray-100 overflow-hidden shadow-sm bg-white">
