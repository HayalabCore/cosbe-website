...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white backdrop-blur-md border-b border-surface-tertiary shadow-sm">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-surface-tertiary bg-white/95 backdrop-blur-md">
            <div className="px-4 md:px-6 py-6 md:py-8 space-y-0 max-w-2xl md:mx-auto">
              ...
              <Link href="/contact" className="flex items-center justify-center gap-2 w-full mt-4 md:mt-6 px-6 py-3 md:py-3.5 bg-primaryColor text-white rounded-full shadow-[0_4px_0_var(--color-primaryHover)] hover:bg-primaryLight hover:shadow-[0_3px_0_var(--color-primaryHover)] active:shadow-[0_1px_0_var(--color-primaryHover)] active:translate-y-[2px] transition-all duration-150 text-sm md:text-base font-bold" onClick={() => setMobileMenuOpen(false)}>
