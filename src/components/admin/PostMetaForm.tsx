              ...
              <div className="flex flex-col gap-1">
                {STATUSES.map((s) => (
                  ...
                  >
                    ...
                    />
                    <span
                      className={`text-sm font-medium ${status === s.value ? 'text-primaryColor' : 'text-slate-700'}`}
                    >
                      {statusLabel(s.value)}
                    </span>
                    {status === s.value && (
                      <svg
                        className="w-3.5 h-3.5 text-primaryColor ml-auto"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                      >
                        <path
          ...
          <div className="px-4 pb-4 space-y-3">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  onChange({ seo: { ...seo, metaDescription: e.target.value } })
                }
              />
