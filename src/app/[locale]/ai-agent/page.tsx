              ...
              <table className="w-full bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <tbody>
                  <tr className="border-b border-surface-tertiary bg-primaryColor/10">
                    <td className="px-6 py-4 font-semibold text-white bg-primaryColor">
                      {t('pricing.agileDev')}
                    </td>
                  ...
                  <tr className="border-b border-surface-tertiary bg-primaryColor/10">
                    ...
                    <td className="px-6 py-4 text-center">
                      <span className="text-errorColor text-2xl font-bold">
                        ✕
                      </span>
                    </td>
                    <td className="px-6 py-4 text-center">
                  ...
                  <tr className="bg-primaryColor/10">
                    ...
                    <td className="px-6 py-4 text-center">
                      <p className="font-bold text-lg">
                        {t('pricing.cosbePriceMain')}
                      </p>
                      <p className="font-bold text-lg">
                        {t('pricing.cosbePriceSub')}
                      </p>
                    ...
                    <td className="px-6 py-4 text-center">
                      <p className="font-bold text-lg">
                        {t('pricing.companyAPrice')}
                      </p>
                      <p className="text-sm text-textTertiary mt-1">
                        {t('pricing.companyAPriceSub')}
                      </p>
                    </td>
                    <td className="px-6 py-4 text-center">
                      <p className="font-bold text-lg">
                        {t('pricing.companyBPrice')}
                      </p>
                      <p className="text-sm text-textTertiary mt-1">
                        {t('pricing.companyBPriceSub')}
                      </p>
                    </td>
                  </tr>
                </tbody>
