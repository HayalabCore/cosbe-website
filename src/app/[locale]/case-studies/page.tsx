...
export default async function CaseStudiesPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Main Content */}
      <div className="bg-[var(--color-brand-alt)] py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Case Studies Grid */}
          <div className="grid md:grid-cols-2 gap-6 mb-16">
            {caseStudies.map((study) => (
              <Link key={study.id} href={`/case-studies/details/${study.slug}`}>
                <div className="group bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 border border-[var(--color-brand-blue)]/20 hover:border-[var(--color-brand-blue)] cursor-pointer">
          ...
          <div className="flex justify-center mb-16">
            <div className="flex items-center gap-2">
              <span className="px-4 py-2 bg-[#5FA4E6] text-white rounded font-semibold">1</span>
            </div>
          </div>
        </div>
      </div>
