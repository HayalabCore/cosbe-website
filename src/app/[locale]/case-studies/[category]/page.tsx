    ...
    <div className="min-h-screen">
      ...
      <div className="bg-gray-50 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <div className="flex items-center text-sm text-gray-600">
            ...
            <span className="mx-2">›</span>
            <span className="text-gray-800">{currentCategory.title}</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white py-12 min-h-[400px]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Page Title */}
          <div className="mb-8">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-800 border-b-2 border-gray-200 pb-4">
              {currentCategory.title}
              <small className="text-sm font-normal text-gray-500 ml-3">– category –</small>
            </h2>
          </div>
          ...
          {filteredCaseStudies.length > 0 ? (
            ...
            <div className="text-center py-16">
              <p className="text-lg text-gray-600">{t('noArticles')}</p>
            </div>
          )}
        </div>
      </div>
