        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <article className="lg:col-span-3 order-1 lg:order-2">
            ...
            <header className="mb-8">
              ...
              <time className="text-textTertiary text-sm">
                {t('publishedDate')}
              </time>
            </header>
              ...
              <ol className="space-y-2 list-decimal list-inside">
                {tableOfContents.map((item) => (
                  <li key={item.id}>
                    <a
                      href={`#${item.id}`}
                      className="text-textSecondary hover:text-primaryColor"
                    >
                      {item.title}
                    </a>
                  </li>
                ...
                <div className="space-y-4 text-textSecondary">
                  ...
                  <div className="bg-primaryColor/10 border-l-4 border-primaryColor p-6 rounded-r-lg">
                    ...
                    <p className="text-textSecondary">
                      {t('sections.overview.mvpDefinition.description')}
                    </p>
                  </div>
                </div>
              </section>
              ...
              <section id="issues-background" className="mb-12 scroll-mt-24">
                ...
                <div className="space-y-6 text-textSecondary">
                  <div>
                    ...
                    <p className="mb-4">
                      {t('sections.issuesBackground.speedIsKey.paragraph1')}
                    </p>
                    <p className="mb-4">
                      {t('sections.issuesBackground.speedIsKey.paragraph2')}
                    </p>
                    <ul className="space-y-3 mb-4">
                      {[0, 1, 2].map((i) => (
                        <li key={i} className="flex items-start">
                          <svg
                            className="w-6 h-6 text-errorColor mr-3 flex-shrink-0 mt-1"
                            fill="currentColor"
                            viewBox="0 0 20 20"
                          >
                            <path
                          ...
                          <span>
                            {t(
                              `sections.issuesBackground.speedIsKey.challenges.${i}`
                            )}
                          </span>
                        </li>
                      ))}
                    ...
                    <p>
                      {t(
                        'sections.issuesBackground.speedIsKey.clientSituation'
                      )}
                    </p>
                  </div>
                  ...
                  <div className="bg-bgSecondary rounded-lg p-6">
                    <h4 className="font-bold text-lg mb-4">
                      {t('sections.issuesBackground.companyInfo.title')}
                    </h4>
                    <table className="w-full">
                      <tbody className="divide-y divide-borderPrimary">
                        <tr>
                          <td className="py-3 pr-4 font-semibold bg-bgTertiary w-1/3">
                            {t('sections.issuesBackground.companyInfo.title')}
                          </td>
                          <td className="py-3">
                            {t(
                              'sections.issuesBackground.companyInfo.companyName'
                            )}
                          </td>
                        </tr>
                        <tr>
                          <td className="py-3 pr-4 font-semibold bg-bgTertiary">
                            {t(
                              'sections.issuesBackground.companyInfo.location'
                            )}
                          </td>
                          <td className="py-3">
                            {t(
                        ...
                        <tr>
                          <td className="py-3 pr-4 font-semibold bg-bgTertiary">
                            {t(
                              'sections.issuesBackground.companyInfo.implementedAI'
                            )}
                          </td>
                          <td className="py-3">
                        ...
                        <tr>
                          <td className="py-3 pr-4 font-semibold bg-bgTertiary">
                            {
                              t(
                                'sections.issuesBackground.companyInfo.keyChallenges'
                              ).split(':')[0]
                            }
                          </td>
                          <td className="py-3">
              ...
              <section id="solutions" className="mb-12 scroll-mt-24">
                ...
                <div className="space-y-6 text-textSecondary">
                  <div>
                    ...
                    <p className="mb-4">
                      {t('sections.solutions.approach.intro')}
                    </p>
                    <p className="mb-4">
                      {t('sections.solutions.approach.paragraph')}
                    </p>
                    <ul className="space-y-3">
                      {[0, 1, 2].map((i) => (
                        <li key={i} className="flex items-start">
                          <svg
                            className="w-6 h-6 text-successColor mr-3 flex-shrink-0 mt-1"
                            fill="currentColor"
                            viewBox="0 0 20 20"
                          >
                            <path
                          ...
                          <span>
                            {t(`sections.solutions.approach.policies.${i}`)}
                          </span>
                        </li>
                      ))}
                    </ul>
                  ...
                  <div>
                    ...
                    <p className="mb-4">
                      {t('sections.solutions.ragLlm.intro')}
                    </p>
                    <p className="mb-4">
                      {t('sections.solutions.ragLlm.mainFlow')}
                    </p>
                    <ol className="space-y-3 mb-4">
                      {[0, 1, 2].map((i) => (
                        <li key={i} className="flex items-start">
                          ...
                          <span className="pt-1">
                            {t(`sections.solutions.ragLlm.steps.${i}`)}
                          </span>
                        </li>
                      ))}
                    </ol>
                    <p className="mb-4">
                      {t('sections.solutions.ragLlm.conclusion')}
                    </p>
                        ...
                        <div key={i}>
                          <p className="text-textSecondary">
                            <strong className="text-primaryDark">
                              {
                                t(
                                  `sections.solutions.ragLlm.definitions.${i}`
                                ).split('?')[0]
                              }
                              ?
                            </strong>{' '}
              ...
              <section id="results" className="mb-12 scroll-mt-24">
                ...
                <div className="space-y-6 text-textSecondary">
                  <div>
                    ...
                    <p className="mb-4">
                      {t('sections.results.prototype.paragraph1')}
                    </p>
                  ...
                  <div>
                    ...
                    <p className="mb-4">
                      {t('sections.results.smallStart.paragraph1')}
                    </p>
              ...
              <section id="summary" className="mb-12 scroll-mt-24">
                ...
                <div className="space-y-4 text-textSecondary">
                  ...
                  <ol className="space-y-3 my-6">
                    {[0, 1, 2].map((i) => (
                      <li key={i} className="flex items-start">
                        ...
                        <span className="pt-1">
                          {t(`sections.summary.keyPoints.${i}`)}
                        </span>
                      </li>
                    ))}
                  </ol>
                  ...
                  <p className="font-semibold">
                    {t('sections.summary.conclusion3')}
                  </p>
                </div>
              </section>
            </div>
            ...
            <div className="mt-8 border-t border-borderPrimary pt-6">
              <p className="text-center text-textTertiary mb-4">
                {t('shareText')}
              </p>
            ...
            <div className="mt-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Link
                  href="/case-studies/details/kando"
                  className="border border-borderPrimary rounded-lg overflow-hidden hover:shadow-lg transition-shadow"
                >
                ...
                <Link
                  href="/case-studies/details/cosbe"
                  className="border border-borderPrimary rounded-lg overflow-hidden hover:shadow-lg transition-shadow"
                >
                  <div className="aspect-video bg-borderPrimary"></div>
                  <div className="p-4">
