...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-brand-bg)] pt-16 md:pt-18 lg:pt-20">
      <section className="relative isolate overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(circle, rgba(95,164,230,0.40) 0%, rgba(95,164,230,0.25) 25%, rgba(95,164,230,0.15) 40%, rgba(95,164,230,0.08) 55%, rgba(95,164,230,0) 75%)',
          }}
        />
        ...
        <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-8 px-4 sm:px-6 py-8 sm:py-12 md:py-16 lg:grid-cols-[1.15fr_0.95fr_0.8fr] lg:items-center lg:gap-10 lg:py-24 z-[3]">
          ...
          <div className="max-w-xl text-center lg:text-left">
            <div className="text-[48px] sm:text-[60px] md:text-[68px] font-extrabold leading-[0.95] tracking-tight text-[var(--color-brand-blue)] lg:text-[84px]">
              {t('brand')}
            </div>
            <div className="mt-3 sm:mt-4 text-[20px] sm:text-[24px] md:text-[30px] font-bold tracking-tight text-[var(--color-brand-heading)] lg:text-[36px]">
              {t('tagline')}
            </div>

            <div className="mt-6 sm:mt-8 lg:mt-10 space-y-3 sm:space-y-4 text-[18px] sm:text-[22px] md:text-[24px] font-semibold leading-relaxed text-[var(--color-brand-body)] lg:text-[28px]">
              <p>
                {t('jpLine1')}
              </p>
              <p>
          ...
          <div className="flex w-full justify-center lg:justify-end mt-[280px] sm:mt-[350px] md:mt-[420px] lg:mt-0">
            <div className="w-[350px] max-w-[480px] sm:max-w-[500px] lg:max-w-[520px] rounded-2xl sm:rounded-3xl bg-white/80 backdrop-blur-sm p-5 sm:p-6 lg:p-8 shadow-[0_20px_60px_rgba(95,164,230,0.12)] sm:shadow-[0_24px_80px_rgba(95,164,230,0.15)] ring-1 ring-[var(--color-brand-alt)] border border-white/20">
              <HubSpotForm />
            </div>
          </div>
        </div>
