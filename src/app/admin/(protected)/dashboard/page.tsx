    ...
    <div className="px-6 py-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <StatCard
          ...
          color="bg-slate-100"
          icon={
            <svg className="w-5 h-5 text-slate-600" fill="none" stroke="currentColor" strokeWidth={1.75} viewBox="0 0 24 24">
        ...
        <StatCard
          ...
          color="bg-amber-50"
          icon={
            <svg className="w-5 h-5 text-amber-600" fill="none" stroke="currentColor" strokeWidth={1.75} viewBox="0 0 24 24">
                      ...
                      <tr key={row.id} className="group hover:bg-slate-50/70 transition-colors">
                        <td className="px-4 py-3.5">
                          <div>
                            ...
                            <p className="text-xs text-slate-400 font-mono mt-0.5 line-clamp-1">{row.slug}</p>
                          </div>
                        </td>
                        ...
                        <td className="px-4 py-3.5 hidden lg:table-cell">
                          <span className="text-sm text-slate-400">{publishedDate ?? '—'}</span>
                        </td>
                        <td className="px-4 py-3.5">
